---
title: "Catapult PTP Grandmaster — catapult_ptp_grandmaster.sv"
description: "IEEE 1588 PTPv2 grandmaster integrating GPS, PHC counter, OCXO discipline loop, and Ethernet timestamping."
part: "Part II — Component Library"
chapter: "Timing & PTPv2 Components"
category: "Timing & PTPv2 Components"
filename: "timing/catapult_ptp_grandmaster.sv"
order: 100
tags: ["Timing & PTPv2 Components", "Under Construction", "Verilog", "FPGA", "Hardware", "Stratix V"]
---

# Catapult PTP Grandmaster — `catapult_ptp_grandmaster.sv`

**Subsystem:** `Timing & PTPv2 Components` &bull; **Source Path:** `timing/catapult_ptp_grandmaster.sv`
...
This module is part of the **Timing & PTPv2 Components** subsystem and is currently undergoing active RTL timing optimization, Quartus Platform Designer netlist verification, and testbench coverage expansion.
...
IEEE 1588 PTPv2 grandmaster integrating GPS, PHC counter, OCXO discipline loop, and Ethernet timestamping.
...
```verilog
// =============================================================================
// Module: Catapult PTP Grandmaster (catapult_ptp_grandmaster.sv)
// Subsystem: Timing & PTPv2 Components
...
module catapult_ptp_grandmaster #(
