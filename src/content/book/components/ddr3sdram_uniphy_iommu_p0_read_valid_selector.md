---
title: "DDR3 P0 Read Valid Selector — ddr3sdram_uniphy_iommu_p0_read_valid_selector.v"
description: "Programmable CAS latency shift-register matching read valid signals to memory read data bursts."
part: "Part II — Component Library"
chapter: "DDR3 Controller Components"
category: "DDR3 Controller Components"
filename: "ddr3/ddr3sdram_uniphy_iommu/ddr3sdram_uniphy_iommu_p0_read_valid_selector.v"
order: 100
tags: ["DDR3 Controller Components", "Under Construction", "Verilog", "FPGA", "Hardware", "Stratix V"]
---

# DDR3 P0 Read Valid Selector — `ddr3sdram_uniphy_iommu_p0_read_valid_selector.v`

**Subsystem:** `DDR3 Controller Components` &bull; **Source Path:** `ddr3/ddr3sdram_uniphy_iommu/ddr3sdram_uniphy_iommu_p0_read_valid_selector.v`
...
This module is part of the **DDR3 Controller Components** subsystem and is currently undergoing active RTL timing optimization, Quartus Platform Designer netlist verification, and testbench coverage expansion.
...
Programmable CAS latency shift-register matching read valid signals to memory read data bursts.
...
```verilog
// =============================================================================
// Module: DDR3 P0 Read Valid Selector (ddr3sdram_uniphy_iommu_p0_read_valid_selector.v)
// Subsystem: DDR3 Controller Components
...
module ddr3sdram_uniphy_iommu_p0_read_valid_selector #(
