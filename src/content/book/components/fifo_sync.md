---
title: "Synchronous FIFO — fifo_sync.v"
description: "Parameterized synchronous circular FIFO buffer with almost_full and almost_empty threshold flags."
part: "Part II — Component Library"
chapter: "Utility Modules"
category: "Utility Modules"
filename: "util/fifo_sync.v"
order: 100
...
**Subsystem:** `Utility Modules` &bull; **Source Path:** `util/fifo_sync.v`
...
Parameterized synchronous circular FIFO buffer with almost_full and almost_empty threshold flags.
...
```verilog
// =============================================================================
// Module: Synchronous FIFO (fifo_sync.v)
