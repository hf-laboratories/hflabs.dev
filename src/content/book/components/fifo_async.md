---
title: "Asynchronous FIFO — fifo_async.v"
description: "Dual-clock asynchronous FIFO with Gray code pointer synchronization across unrelated clock domains."
part: "Part II — Component Library"
chapter: "Utility Modules"
category: "Utility Modules"
filename: "util/fifo_async.v"
order: 100
...
**Subsystem:** `Utility Modules` &bull; **Source Path:** `util/fifo_async.v`
...
Dual-clock asynchronous FIFO with Gray code pointer synchronization across unrelated clock domains.
...
```verilog
// =============================================================================
// Module: Asynchronous FIFO (fifo_async.v)
