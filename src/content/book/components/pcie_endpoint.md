---
title: "PCIe Endpoint — pcie_endpoint.v"
description: "Top-level PCIe Gen3 x8 endpoint integrating Hard IP, BAR decoding, and Avalon-ST channels."
...
# PCIe Endpoint — `pcie_endpoint.v`

**Subsystem:** `PCIe & HIP Unlock Components` &bull; **Source Path:** `pcie_endpoint.v`
...
Top-level PCIe Gen3 x8 endpoint integrating Hard IP, BAR decoding, and Avalon-ST channels.
...
```verilog
// =============================================================================
// Module: PCIe Endpoint (pcie_endpoint.v)
